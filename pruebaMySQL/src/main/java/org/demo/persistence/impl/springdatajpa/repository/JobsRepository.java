...
/**
 * Spring data Jpa repository for "Jobs" <br>
 * @author Telosys (http://www.telosys.org/) version 3.1.2
 */
@Repository
public interface JobsRepository extends JpaRepository<JobsJpaRecord, Integer>, JpaSpecificationExecutor<JobsJpaRecord> {
}